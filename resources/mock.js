...
const pool = new Pool({
    database: process.env.POSTGRES_DB || "CHANGE_ME",
    user: process.env.POSTGRES_USER || "CHANGE-ME",
...
async function main() {
    ...
    for (let i = 0; i < 25; i++) {
        ...
        const query = {
            text: `INSERT INTO public.users(username, first_name, last_name, email, phone_number, password) VALUES($1, $2, $3, $4, $5, $6)`,
    ...
    for (let i = 0; i < 25; i++) {
        ...
        const query = {
            text: `INSERT INTO scams.domains(domain, classification, reported_by) VALUES($1, $2, $3)`,
        ...
        const updateQuery = {
            text: `UPDATE scams.classifications SET domain_count = domain_count + 1 WHERE id = $1`,
    ...
    for (let i = 0; i < 25; i++) {
        ...
        const query = {
            text: `INSERT INTO scams.emails(email, classification, reported_by) VALUES($1, $2, $3)`,
        ...
        const updateQuery = {
            text: `UPDATE scams.classifications SET email_count = email_count + 1 WHERE id = $1`,
    ...
    for (let i = 0; i < 25; i++) {
        ...
        const query = {
            text: `INSERT INTO scams.links(link, classification, reported_by) VALUES($1, $2, $3)`,
        ...
        const updateQuery = {
            text: `UPDATE scams.classifications SET link_count = link_count + 1 WHERE id = $1`,
    ...
    for (let i = 0; i < 25; i++) {
        ...
        const query = {
            text: `INSERT INTO scams.phone_numbers(phone_number, classification, reported_by) VALUES($1, $2, $3)`,
        ...
        const updateQuery = {
            text: `UPDATE scams.classifications SET phone_count = phone_count + 1 WHERE id = $1`,
